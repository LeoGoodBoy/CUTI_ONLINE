 ...
 * @author chochong
 */
@WebServlet(name = "PermohonanServlet", urlPatterns = {"/PermohonanServlet"})
public class PermohonanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            session.setAttribute("dataPermohonan", ic.getAll());
            dispatcher = request.getRequestDispatcher("/view/lihatpermohonan.jsp");
