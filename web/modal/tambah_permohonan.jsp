<div class="modal fade" id="tambahKaryawan" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form name="aisyah_mentel" method="post" action="./saveOrUpdateKaryawanServlet">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-header"><strong>Tambah Data Karyawan</strong><small></small></div>
